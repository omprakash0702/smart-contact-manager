...
public class ContactController {
   ...
   // private ImageService imageService;
    ...
    // API: fetch single contact (for modal view 👁️)
    @GetMapping("/{id}")
    @ResponseBody
    public Contact getContact(
        ...
        // security check: contact must belong to logged-in user
    ...
    public boolean toggleFavorite(
        ...
        Contact updated = contactService.toggleFavorite(id, user);
    ...
    public String viewFavoriteContacts(
        ...
        Page<Contact> pageContact =
                contactService.getFavoriteContacts(user, page, size, sortBy, direction);
